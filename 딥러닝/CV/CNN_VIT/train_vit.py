...
def get_args():
    ...
    parser.add_argument('--expansion_ratio', default=2, type=int)
...
def main(args):
    ...
    model = VisionTransformer(
        args.blocks, args.embed_dim, args.num_classes, 
        args.image_size, args.patch_size, args.num_heads, 
        args.expansion_ratio, args.droppath, args.dropout)
